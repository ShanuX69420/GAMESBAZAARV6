/**
 * Neutral SVG fallbacks for games/success states when no uploaded icon is
 * available. Admin can upload proper game icons via the Django admin panel.
 */

export function GameIconFallback({ size = 24 }) {
  return (
    <svg
      width={size}
      height={size}
